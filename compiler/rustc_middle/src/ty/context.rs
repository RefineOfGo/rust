...
use crate::ty::{
    ...
    TypingEnv, ValTree, ValTreeKind, Visibility,
};
...
pub struct GlobalCtxt<'tcx> {
    ...
    pub noptr_cache: Lock<FxHashMap<(TypingEnv<'tcx>, Ty<'tcx>, Option<VariantIdx>), bool>>,
    pub pointer_maps: Lock<FxHashMap<(TypingEnv<'tcx>, Ty<'tcx>), PointerMap>>,

    /// Caches the result of Register Map calculation for each Ty.
    pub register_maps: Lock<FxHashMap<(TypingEnv<'tcx>, Ty<'tcx>), Option<Vec<Reg>>>>,
