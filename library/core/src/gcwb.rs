...
pub unsafe fn enable() {
    unsafe { crate::intrinsics::atomic_store_seqcst(&raw mut rog_gcwb_switch, 1) }
}
...
pub unsafe fn disable() {
    unsafe { crate::intrinsics::atomic_store_seqcst(&raw mut rog_gcwb_switch, 0) }
}
...
pub fn is_enabled() -> bool {
    unsafe { crate::intrinsics::atomic_load_seqcst(&raw const rog_gcwb_switch) != 0 }
}
